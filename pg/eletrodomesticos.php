<?php require_once("topo.php");?>
      <section id="topoEletrodomestico">
        <h1> Sessão EletroDomestiscos </h1>
        <h4> TV, Geladeiras,Fogões, etc... </h4>
      </section>
    <article id ="pg_eletrodomesticos">
         <div class="bs-example">
          ...
          <div class="col-sm-6 col-md-4">
            ...
            <div class="col-sm-6 col-md-4">
              ...
              <div class="caption">
                <h4>TV 32" Samsung</h4>
                <p>DigitalTV / HDMI / USB / Som Stereo <br /><b> Preço R$ 1.500,00 </b></p>
                <p> <a href="#" class="btn btn-primary" role="button">Comprar Agora </a>
                    <a href="#" class="btn btn-default" role="button">Adicionar </a>
                </p>
              </div>
          ...
          <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
              <img data-src="holder.js/100%x100" alt="Produto -C&M-"  src="../img/categorias/anuncios/eletrodomestico/6.jpg" data-holder-rendered="true"/>
            <div class="caption">
              <h4> FOGÃO - CONSUL </h4>
              <p> 5 Bocas / Elétrico / AutoLimpante <br /><b>Preço R$ 1.500,00</b></p>
              <p> <a href="#" class="btn btn-primary" role="button">Comprar Agora </a>
                  <a href="#" class="btn btn-default" role="button">Adicionar </a>
              </p>
            </div>
